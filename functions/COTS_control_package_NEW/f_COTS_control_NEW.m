...
unvisited_ID = []; if istable(unvisited); unvisited_ID = unvisited.Reef_ID; end
control_records=struct('culled_reef_ID',[], 'culled_density_reef',[], 'nb_culled_COTS',[],...
    ...
    'nb_control_sites' , [], 'nb_unvisited_reefs', height(unvisited), 'unvisited_reef_ID', unvisited_ID, ...
